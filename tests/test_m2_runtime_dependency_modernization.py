...
class M2RuntimeDependencyModernizationTests(unittest.TestCase):
    def test_official_runtime_and_tzdata_are_exactly_pinned(self) -> None:
    ...
    def test_active_runtime_paths_have_no_stale_312_contract(self) -> None:
        stale = (
    ...
    def test_current_windows_workflows_use_python_31314(self) -> None:
        workflow_files = tuple(
            relative for relative in ACTIVE_RUNTIME_FILES
            if relative.startswith(".github/workflows/")
            and relative not in (".github/workflows/foundation-ci.yml", ".github/workflows/oss-admission-ci.yml")
        )
