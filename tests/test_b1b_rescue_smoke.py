...
def money_rule():
    value = {
        "rule_id": "pilot-money-expression",
        "version": 1,
        "content_hash": "",
...
def context():
    return {
        ...
        "mode": "ACTUAL",
        "scenario_id": None,
        "calculation_instant": "2026-07-01T00:00:00Z",
        "marketplace_account_id": None,
        "marketplace": None,
        "product_id": None,
        "product_group_id": None,
        "calculation_profile_id": "profile-1",
    ...
    def test_kernel_matches_independent_oracle(self):
        ...
        case = {
            ...
            "inputs": {
                ...
                "reverse_logistics_amount": "100",
                "storage_amount": "100",
                "advertising_amount": "200",
                "fines_withholdings_amount": "0",
            },
            "gross_sales_units": 10,
            "returned_units": 2,
            "resalable_returned_units": 2,
