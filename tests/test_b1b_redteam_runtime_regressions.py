...
def valid_request() -> dict:
    ...
    inputs = {
        ...
        "marketplace_commission_amount": typed("VALID", "1000", "MONEY", "MONEY", "RUB"),
        "forward_logistics_amount": typed("VALID", "500", "MONEY", "MONEY", "RUB"),
        "reverse_logistics_amount": typed("VALID", "100", "MONEY", "MONEY", "RUB"),
    ...
    return {
        ...
        "profile_ref": {"id": "profile-1", "version": 1, "content_hash": "0" * 64},
        "profile_status": "PILOT",
        "rounding_policy": policy(),
        "currency": "RUB",
        "inputs": inputs,
        "cost_per_unit": typed("VALID", "400", "MONEY", "MONEY_PER_ITEM", "RUB"),
        "other_expense_components": [
            {"component_id": "other-per-unit", "value": typed("VALID", "40", "MONEY", "MONEY_PER_ITEM", "RUB")}
        ],
