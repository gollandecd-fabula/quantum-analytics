...
class FinanceCenterPagesMixin:
        ...
        def _build_decision_page(self) -> None:
            ...
            self.decision_add_button = ttk.Button(action_bar, text="Выбрать и запустить отчёты", style="Success.TButton", command=self.add_reports)
        ...
        def _build_reports_page(self) -> None:
            ...
            self.reports_add_button = ttk.Button(controls, text="Выбрать и запустить отчёты", style="Success.TButton", command=self.add_reports)
